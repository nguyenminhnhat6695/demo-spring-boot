...
<c:url var="newURL" value="/quan-tri/bai-viet/danh-sach?page=1&limit=5&sortName=title&sortBy=desc"/>
...
<script>
	$('#btnAddOrUpdateNew').click(function (e) {
		// Để xác định url gọi đến API cho đúng, chứ ko phải lấy url hiện tại để gọi 
		// 35:40 - API restful web service phần 2
		// Nếu ko khai báo e.pre... thì nó sẽ setting mặc định url đang đứng hiện tại của trang đó
	    e.preventDefault();
	    var data = {};
